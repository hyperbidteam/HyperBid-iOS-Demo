...
//  HyperBidDemo
//
//  Created by HyperBid on 2025/1/5.
//
...
#define DemoLogAccess(l) ({\
    ...
    [[NSUserDefaults standardUserDefaults] setBool:isOpenLog forKey:@"HyperBidDemoLogSw"]; \
})
...
#define kUIRefereWidth  (isiPAD?804.f:804.f)
#define kUIRefereHeight (isiPAD?1748.f:1748.f)
